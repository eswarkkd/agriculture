	 ...
	 render(){
		...
		<div className="container-fluid main_div_new">
			...
			<div className="row no-margin">
				...
				<div className="col-sm-6 col-6 text-left"><b>Total Records {this.state.total_records}</b></div>
				...
				<div className="tablel-responsive">
					...
					<tr key={i}>
						...
						<td><Link to="edit_former" onClick={(e)=>this.global_var(e,former.id)}>Edit</Link> <input type="button" value="delete" name={former.id} onClick={(e)=>this.delete_row(e,former.id,i)} /> </td>
					</tr>					
					)):""}
